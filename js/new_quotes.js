/* 
 quotes.js
 massive quote array and selects random 
 index number to grab random quote
*/
...
var quote_list = [
    ...
    "Be quiet! It's only (t)! I, Damp\u03b9 the gravekeeper, am in bed now! Go away and play! Maybe you can find a ghost in the daytime?", 
    "It's (t) now. The Gravedigging Tour is over now! I, Damp\u03b9 the gravekeeper, am in bed! Go away and play! Maybe you'll find a ghost!", 
    ...
    "The record time of those who raced against me was:  --Damp\u03b9 the Gravekeeper", 
    ...
    "Heart-Pounding Gravedigging Tour! From 18:00 to 21:00 Hyrule Time --Damp\u03b9 the Gravekeeper", 
    ...
    "Damp\u03b9's Ghost That's the ghost of the dead gravekeeper! If you chase him, he might give you his keepsake...", 
    ...
    "Poe This Poe doesn't disappear even if you stare at it. It doesn't spook easily, does it... You can't warp here!", 
    ...
    "With this mask, I'll be just like Damp\u03b9! Here's my money!", 
    "I'm gonna dig and dig! Just like Damp\u03b9!!", 
    ...
    "Whoever reads this, please enter my grave. I will let you have my stretching, shrinking keepsake. I'm waiting for you. --Damp\u03b9", 
    ...
    "Don't cause trouble! I'll tell Damp\u03b9!", 
    ...
    "That's not very different from Mr. Damp\u03b9, is it?", 
    "That doesn't look anything like Mr. Damp\u03b9, huh?", 
...
function init()
{
  num = quote_list.length;

  ran_num = getRandomIntInclusive(0, num - 1);
  document.getElementById("quote").innerHTML = quote_list[ran_num];     

  var current_quote = "";
  var tweet_url_prefix = "https://twitter.com/intent/tweet?text=";

  var enc_quote = encodeURI(quote_list[ran_num]);
  var tweet_url = tweet_url_prefix.concat(enc_quote);
...
{
  var ran_num = getRandomIntInclusive(0, num - 1);
  var current_quote = quote_list[ran_num];
  document.getElementById("quote").innerHTML = current_quote;     
  var enc_quote = encodeURI(current_quote);
  tweet_url_prefix = "https://twitter.com/intent/tweet?text=";
  var tweet_url = tweet_url_prefix.concat(enc_quote);
  document.getElementById("tweet").setAttribute("href", tweet_url);
